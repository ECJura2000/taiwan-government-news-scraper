...
2. Create and push immutable tag `v2.1.18`; do not modify any previous tag or Release, including the published rollback `v2.0.0`.
...
7. Run `Release live smoke` for `v2.1.18` and verify all published downloads, including the extracted Windows portable GUI rendered-interface marker.

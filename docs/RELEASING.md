...
2. Create and push immutable tag `v2.1.1`; do not modify `v2.0.0` or the failed, unpublished `v2.1.0` candidate tag.
...
6. Run `Release live smoke` for `v2.1.1` and verify all four published downloads.

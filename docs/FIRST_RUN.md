...
- Windows: download and run `TaiwanGovernmentNews-Setup-v2.1.9.exe` for normal use. If you need the portable ZIP, extract it completely and double-click the top-level `各機關新聞整理.exe`; use `cli/news-scraper.exe collect` only for advanced CLI work.

...
5. The signed v2.1.0 and v2.1.1 candidates did not pass their source gates and remain unpublished. Use the unchanged v2.0.0 GitHub Release as rollback until v2.1.2 passes all source and artifact gates; do not overwrite any tag or release.

# v2.1.2 Project Report

v2.1.2 replaces the previous scraper runtime with Rust across CLI, Tauri, 72 source routes, CDP, quality diagnostics, relevance rules, Excel and schema-v4 JSON. It serializes CDP startup on low-resource runners, adds a browser fallback for the Ministry of Culture, and preserves complete retry evidence without treating classified external availability failures as code regressions.
